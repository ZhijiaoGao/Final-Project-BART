...
##################################
# ATTENTION CHECK
# Ensuring participants are not just randomly pressing SPACE
##################################
...
#########################
#One Practice Trial
#Identical logic to actual trials, but earnings do not count
#########################
for trial in range(n_practice_trial):
    ...
    while True:
        ...
        if 'space' in keys:
            ...
            balloon.radius += 3
            explosion_prob = 1/(max_pumps - pumps + 1)#Probability increases as number of pumps increases (standard BART)
